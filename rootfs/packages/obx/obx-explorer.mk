...
$(OBX_EXPLORER_DIR)/.configured: update
	(cd $(OBX_EXPLORER_DIR); \
...
$(HOST_DIR)$(EPREFIX)/bin/obx_explorer: $(OBX_EXPLORER_DIR)/obx_explorer
	cp -dpf $(OBX_EXPLORER_DIR)/obx_explorer $(HOST_DIR)$(EPREFIX)/bin
	touch -c $(HOST_DIR)$(EPREFIX)/bin/obx_explorer

$(TARGET_DIR)$(EPREFIX)/bin/obx_explorer: $(HOST_DIR)$(EPREFIX)/bin/obx_explorer
	cp -dpf $(HOST_DIR)$(EPREFIX)/bin/obx_explorer $(TARGET_DIR)$(EPREFIX)/bin
	-$(TARGET_STRIP) $(TARGET_DIR)$(EPREFIX)/bin/obx_explorer
	touch -c $(TARGET_DIR)$(EPREFIX)/bin/obx_explorer

obx_explorer: onyx-lib $(TARGET_DIR)$(EPREFIX)/bin/obx_explorer
